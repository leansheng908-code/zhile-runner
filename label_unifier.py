...
_SYSTEM_CONFIGS = [
    ...
    {"id": "economic_cycle", "name": "经济周期", "dir": "economic_cycle", "module": "economic_cycle_label_dictionary", "func": "generate_labels_from_timestamp", "dims": 22},
]
...
_NORMALIZERS = {
    ...
    "economic_cycle": _normalize_layers_system,
}
